...
public class Main
{
    ...
    {
        //Standard constructor takes the value of P and G, the prime and the nererator for the gorup represented by prime
        ...
        System.out.println("A: " + CryptoUtils.toHex(aShared));
        System.out.println("B: " + CryptoUtils.toHex(bShared));
